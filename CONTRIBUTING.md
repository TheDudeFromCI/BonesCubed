...
1. Make an [Issue](https://github.com/TheDudeFromCI/BonesCubed/issues/new)
...
```json
    {
        "dependencies": {
            "net.whg.bonescubed": "https://github.com/YOUR_USER/BonesCubed.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at thedudefromci@gmail.com.
